 ...
 */
public class EventUpload extends Activity implements GoogleApiClient.ConnectionCallbacks,
        GoogleApiClient.OnConnectionFailedListener {

    private static final String TAG = "Event Upload";
        ...
        Drive.DriveApi.newDriveContents(mGoogleApiClient)
                .setResultCallback(new ResultCallback<DriveApi.DriveContentsResult>() {
                    ...
                    public void onResult(DriveApi.DriveContentsResult result) {
                        ...
                        // Create the initi al metadata - MIME type and title.
        ...
        switch (requestCode) {
            ...
            case REQUEST_CODE_CREATOR:
                ...
                if (resultCode == RESULT_OK) {
                    ...
                    if (getIntent().getExtras().getString("event_or_meet").equals("MEET")) {
                        Intent i = new Intent(getApplicationContext(),
                                FinalMeetSummary.class);
                    ...
                    else if(getIntent().getExtras().getString("event_or_meet").equals("EVENT"))
                    {
                        Intent i = new Intent(getApplicationContext(),
                                FinalEventSummary.class);
