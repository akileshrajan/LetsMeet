...
public class CalendarActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mAccUnSpec = new ProgressDialog(this);
        mProgress = new ProgressDialog(this);
    ...
    protected void onResume() {
        ...
        if (isGooglePlayServicesAvailable()) {
            ...
            mPlayServ.setMessage("Google Play Services required: " +
        ...
        switch(requestCode) {
            ...
            case REQUEST_ACCOUNT_PICKER:
                if (resultCode == RESULT_OK && data != null &&
                    ...
                    mAccUnSpec.setMessage("Account unspecified.");
                }
                break;
    ...
    private void refreshResults() {
        if (mCredential.getSelectedAccountName() == null) {
            ...
            if (isDeviceOnline()) {
                ...
                mNoNetwork.setMessage("No network connection available.");
            }
        }
    }
        ...
        private List<String> getDataFromApi() throws IOException {
            ...
            for (Event event : items) {
                ...
                if (start == null) {
                    ...
                    if(MeetDate.equals(getdate.format(start))) {
        ...
        protected void onCancelled() {
            ...
            if (mLastError != null) {
                if (mLastError instanceof GooglePlayServicesAvailabilityIOException) {
                    ...
                    mError.setMessage("The following error occurred:\n"
