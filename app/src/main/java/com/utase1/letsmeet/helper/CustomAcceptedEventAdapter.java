...
public class CustomAcceptedEventAdapter extends ArrayAdapter {

    private Activity activity;
    private List<AcceptedEventModel> acceptedArrayList;

    private LayoutInflater inflater;

    public CustomAcceptedEventAdapter(Context context,int resource ,List<AcceptedEventModel> results) {
